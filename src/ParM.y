...
VarSpec :: { VarSpec }
VarSpec : Ident ListArrayDimension { AbsM.V_Spec $1 (reverse $2) }
...
FunDeclaration : 'fun' Ident ParamList ':' Type '{' FunBlock '}' { AbsM.D_Function $2 $3 $5 $7 }
FunBlock :: { FunBlock }
...
BasicDeclaration : Ident ListBasicArrayDimension ':' Type { AbsM.BasicDec $1 (reverse $2) $4 }
BasicArrayDimension :: { BasicArrayDimension }
BasicArrayDimension : '[' ']' { AbsM.B_ArrDim }
DataDeclaration :: { DataDeclaration }
DataDeclaration : 'data' Ident '=' ListConsDecl { AbsM.D_Data $2 $4 }
ConsDecl :: { ConsDecl }
...
Location :: { Location }
Location : Ident ListArrayDimension { AbsM.L_Location $1 (reverse $2) }
Case :: { Case }
Case : CID VarList '=>' ProgStmt { AbsM.C_Case $1 $2 $4 }
VarList :: { VarList }
VarList : '(' ListIdent ')' { AbsM.VL_List $2 }
        | {- empty -} { AbsM.VL_End }
Expr :: { Expr }
...
IntFactor : '(' Expr ')' { AbsM.IF_Expression $2 }
          | 'size' '(' Ident ListBasicArrayDimension ')' { AbsM.IF_Size $3 (reverse $4) }
          | 'float' '(' Expr ')' { AbsM.IF_Float $3 }
          | 'floor' '(' Expr ')' { AbsM.IF_Floor $3 }
          | 'ceil' '(' Expr ')' { AbsM.IF_Ceil $3 }
          | Ident ModifierList { AbsM.IF_ID $1 $2 }
