...
instance Print Term where
  prt i e = case e of
    TMul term factor -> prPrec i 0 (concatD [prt 0 term, doc (showString "*"), prt 0 factor])
    TFact factor -> prPrec i 0 (concatD [prt 0 factor])

instance Print Factor where
  prt i e = case e of
    Num n -> prPrec i 0 (concatD [prt 0 n])
